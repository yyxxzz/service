package com.yoho.gateway.controller.order.payment.wechat;
...
public class ConfigUtil {
	...
	// "partner_id":1218934901}
	 public final static String APPID = "wx049fdaa3ba9cdd7a";//服务号的应用号
	 public final static String APP_SECRECT = "f973fdb412307ea7b97d0252fd675104";//服务号的应用密码
	 public final static String TOKEN = "weixinCourse";//服务号的配置token
	 public final static String MCH_ID = "1218934901";//商户号
	 public final static String API_KEY = "7e6f3307b64cc87c79c472814b88f7fb"; //"b22de5cfd0ded341e0516505f72649a9";//API密钥
	 public final static String SIGN_TYPE = "MD5";//签名加密方式
	 public final static String CERT_PATH = "D:/apiclient_cert.p12";//微信支付证书存放路径地址
	//微信支付统一接口的回调action
	 public final static String NOTIFY_URL = "http://123.56.138.21:9090/testpay_Web/notify"; //"http://14.117.25.80:8016/wxweb/config/pay!paySuccess.action";
	//微信支付成功支付后跳转的地址
