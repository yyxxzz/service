...
import com.yoho.gateway.controller.order.payment.unionpay.BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier;
...
public class HttpClient {
	...
	public int send(Map<String, String> data, String encoding) throws Exception {
		try {
			...
			if(null == httpURLConnection){
				throw new Exception("Failed to create connnection!");  // 创建联接失败
			}
			...
			logger.debug("Sync returned resp:{}", result);  // 同步返回报文
	...
	private String getRequestParamString(Map<String, String> requestParam, String coder) {
		...
		logger.debug("Req data(URLEncoded):{}", reqstr);  //  请求报文(已做过URLEncode编码)
		return reqstr;
	}
